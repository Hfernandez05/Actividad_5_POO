...
public class VentanaCilindro extends JFrame implements ActionListener {
	...
	private JLabel radio, altura, volumen, superficie;	// Etiquetas estáticas para identificar los campos de texto a ingresar y calcular
	private JTextField campoRadio, campoAltura;	// Campos de texto a ingresar
